...
#define scanTime         CONFIG_SCAN_TIME
#define waitTime         CONFIG_WAIT_TIME
#define known_devices    CONFIG_KNOWN_BLE_DEVICE_MACS

static const char remote_device_name[] = "ESP_GATTS_FADA";
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: 
    {
        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT:
            if (strcmp(known_devices,"NULL")==0){

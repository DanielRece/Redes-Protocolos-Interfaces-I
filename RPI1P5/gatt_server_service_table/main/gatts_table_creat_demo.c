...
#define SAMPLE_DEVICE_NAME          "ESP_GATS_FADA"
...
static uint8_t raw_adv_data[] = {
        ...
        0x03, 0x03, 0xFF, 0x00,
        /* device name */
        0x0f, 0x09, 'E', 'S', 'P', '_', 'G', 'A', 'T', 'T', 'S', '_', 'F','A', 'D', 'A'
};
...
static uint8_t char_value[4]                 = {0x22, 0x33, 0x33, 0x66};
...
static void publish_data_task(void* params){
    while(1){
            ...
            if (!param->write.is_prep){
                ...
                if (heart_rate_handle_table[IDX_CHAR_CFG_A] == param->write.handle && param->write.len == 2){
                    ...
                    if (descr_value == 0x0001){
                        ...
                        heart_measurement_ccc[0] = 0x01;
                        heart_measurement_ccc[1] = 0x00;    
